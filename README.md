...
**RMUTP_CARBOT** 
เป็นไลบรารี Arduino สำหรับควบคุมรถยนต์ 2 ล้อ (2WD Robot Car) 
โดยใช้ ESP32 และไดร์เวอร์มอเตอร์ L298N
...
# 🔁 การเลี้ยว
// =======================================
// 🔁 การเลี้ยว (ใช้งานฟังก์ชัน)
// =======================================

// 🟡 เลี้ยวแบบโค้ง (Soft Turn)

// ➡️ เลี้ยวขวา
car.TurnRight1(100);  
// ล้อซ้ายเดินหน้า / ล้อขวาหยุด
// → รถเลี้ยวขวาแบบโค้ง

// ⬅️ เลี้ยวซ้าย
car.TurnLeft1(100);   
// ล้อซ้ายหยุด / ล้อขวาเดินหน้า
// → รถเลี้ยวซ้ายแบบโค้ง
...
// 🔄 หมุนขวา
car.TurnRight2(100);  
// ล้อซ้ายเดินหน้า / ล้อขวาถอยหลัง
// → รถหมุนขวา (ตามเข็มนาฬิกา)

// 🔄 หมุนซ้าย
car.TurnLeft2(100);   
// ล้อซ้ายถอยหลัง / ล้อขวาเดินหน้า
// → รถหมุนซ้าย (ทวนเข็มนาฬิกา)
...
<p align="left">
  <img src="image/spg.png" width="40"/>
</p>
